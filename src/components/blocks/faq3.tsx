...
const Faq3 = ({
  ...
  description = "Find answers to common questions about our construction services, project timelines, and pricing. Can't find what you're looking for? Contact our support team for more details.",
  items = faqItems,
